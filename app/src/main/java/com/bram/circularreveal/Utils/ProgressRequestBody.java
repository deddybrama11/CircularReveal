package com.bram.circularreveal.Utils;
...
public class ProgressRequestBody extends RequestBody {
    ...
    public void writeTo(BufferedSink sink) throws IOException {
        ...
        try {
            ...
            {
                handler.post(new ProgresUpdater(uploaded, fileLength));
                uploaded+=read;
    ...
    private class ProgresUpdater implements Runnable {
        private long uploaded;
        private long fileLength;

        public ProgresUpdater(long uploaded, long fileLength) {
